...
const BILLING_CODES = `H101 (ED Assessment): Minor assessment – Day (8am–5pm)
...
K734 (Consultations): Phone consult – referring physician -- ≥10 min; cannot lead to follow-up
K735 (Consultations): Phone consult – consultant physician -- ≥10 min; cannot lead to follow-up
...
Key billing rules:
- Bill ONE assessment per visit — choose the right time slot (Day/Eve Mon-Thu/Wkd+FriEve/Night) and complexity (Minor/Comprehensive/Multiple)
- H15x (H151-H154) are used on weekends and holidays instead of H10x/H13x/H12x
...
- Call-in codes (E998C) apply when called in from home
- Premiums stack ON TOP of the base assessment or procedure code

Common abbreviations: lac=laceration, FB=foreign body, I&D=incision and drainage, Fx=fracture, CVA=stroke, MI=myocardial infarction, SOB=shortness of breath
...
- Return the most relevant codes for the scenario, up to 6 codes, ranked by importance
- For most encounters include the assessment code + any applicable premiums
- For procedures include the procedure code + assessment + applicable premiums
- Respond ONLY with a valid JSON object:
  {"results": [{"code": "H102", "description": "Comprehensive assessment - Day", "category": "ED Assessment", "reason": "Complex ED visit"}, ...]}
- The "reason" field is a short phrase (max 6 words) explaining why this code applies
